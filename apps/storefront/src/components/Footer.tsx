      ...
      <footer className="bg-cream px-4 pb-8 pt-14 md:px-8 md:pt-20" style={{ borderTop: "1px solid rgba(184,151,106,0.15)" }}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col items-center text-center md:mb-12">
            <Link href="/#top" aria-label="Rosta Coffee Co anasayfa" className="mb-4 inline-flex"><img src="/rosta-coffee-co-v4.webp" alt="" className="h-[66px] w-[240px] object-contain sm:w-[280px]" /></Link>
