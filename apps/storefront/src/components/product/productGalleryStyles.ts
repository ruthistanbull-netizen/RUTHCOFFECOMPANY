...
.ruth-product-lightbox{position:fixed;inset:0;z-index:1200;width:100vw;height:100dvh;overflow:hidden;background:rgba(24,20,17,.22);-webkit-backdrop-filter:blur(24px) saturate(.9);backdrop-filter:blur(24px) saturate(.9);overscroll-behavior:none;touch-action:none}
...
.ruth-product-lightbox__topbar{position:absolute;top:0;right:0;left:0;z-index:20;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:14px;padding:calc(18px + env(safe-area-inset-top)) max(22px,env(safe-area-inset-right)) 28px max(22px,env(safe-area-inset-left));background:linear-gradient(180deg,rgba(16,14,12,.24) 0%,rgba(16,14,12,.08) 48%,transparent 100%);pointer-events:none}
.ruth-product-lightbox__meta{min-width:0;display:grid;gap:4px;color:#fff;pointer-events:auto;text-shadow:0 2px 18px rgba(0,0,0,.42)}
.ruth-product-lightbox__meta span{color:rgba(255,255,255,.72);font-size:8px;line-height:1;letter-spacing:.19em;text-transform:uppercase}
...
.ruth-product-lightbox__zoom-controls{position:absolute;right:max(18px,env(safe-area-inset-right));bottom:calc(18px + env(safe-area-inset-bottom));z-index:21;display:grid;grid-template-columns:42px 58px 42px;align-items:center;overflow:hidden;border:1px solid rgba(255,255,255,.35);border-radius:999px;background:rgba(250,247,241,.78);box-shadow:0 12px 36px rgba(0,0,0,.16);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}
.ruth-product-lightbox__zoom-controls button{display:grid;width:42px;height:42px;place-items:center;border:0;background:transparent;color:#211912;transition:opacity .18s ease,transform .18s ease,background .18s ease}
...
.ruth-product-lightbox__zoom-controls span{display:grid;height:42px;place-items:center;border-right:1px solid rgba(33,25,18,.09);border-left:1px solid rgba(33,25,18,.09);font-size:8px;letter-spacing:.08em;font-variant-numeric:tabular-nums}
...
@media(hover:hover){
  ...
  .ruth-product-lightbox__zoom-controls button:not(:disabled):hover{background:rgba(33,25,18,.06)}
}
