...
export function OrderSuccessRuthieAnimation({ orderNo }: Props) {
      ...
      <div className="order-success-guest mt-6 rounded-2xl border border-gold/15 bg-ivory p-5">
        <div className="order-success-guest-row">
          ...
          <div className="order-success-guest-copy">
            <p className="font-heading text-lg">Ruthie Points kazanmak için üye ol</p>
            <p className="mt-2 text-sm leading-6 text-muted-ruth">
              Hesap oluşturduğunda alışverişlerinden Ruthie Points kazanabilir, ödeme adımında indirim olarak kullanabilirsin.
            </p>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex justify-center">
        <span className="ruthie-success-badge"><Sparkles size={17} /> Ruthie Points</span>
      </div>
      <motion.h2
      ...
      >
        {isRewardReady && earnedPoints > 0
          ? `Bu alışverişten +${formatRuthieNumber(earnedPoints)} Ruthie Points hesabına eklendi.`
          : "Alışverişlerin hesabında Ruthie Points olarak birikir ve ödeme adımında indirime dönüşür."}
      </motion.p>
