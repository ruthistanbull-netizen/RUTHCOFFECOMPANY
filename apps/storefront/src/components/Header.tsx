      ...
      <AnimatePresence>
        {open ? (
          <>
            ...
            />
            <motion.div
              className="absolute right-0 top-full z-[73] mt-2 w-52 border border-black/10 bg-white px-3 py-3 shadow-[0_18px_50px_rgba(0,0,0,.10)]"
...
export function Header({
  ...
  const darkMenuSurface = isDarkColor(themeSettings.colors.ivory);
  const menuControlColor = darkMenuSurface ? "#ffffff" : "#111111";
  const menuToneStyle = {
    "--ruth-menu-control-color": menuControlColor,
    "--ruth-menu-logo-filter": darkMenuSurface
        ...
        <div className="ruth-zara-header-inner grid w-full grid-cols-[1fr_auto_1fr] items-center">
          ...
          <div className="flex items-center justify-end gap-0.5 sm:gap-1">
            ...
            >
              ...
              {count > 0 ? (
                <span className="absolute right-0 top-0 flex h-4 min-w-4 items-center justify-center rounded-full bg-black px-1 text-[8px] font-semibold text-white">
                  {count}
                </span>
              ) : null}
            </button>
            ...
            <div className="mx-auto max-w-4xl pt-28 sm:pt-36">
              ...
              >
                ...
                <input
                  ...
                  className="w-full bg-transparent text-[clamp(1.6rem,4vw,3.5rem)] font-light outline-none placeholder:text-black/25"
                />
              </form>
