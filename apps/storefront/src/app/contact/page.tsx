...
export const metadata = {
  title: "İletişim",
  description: "Ruth Istanbul iletişim ve destek.",
};
...
const CONTACT_CARDS = [
  {
    icon: MessageCircle,
    title: "Canlı Destek",
    desc: "Canlı destek kapalıysa WhatsApp üzerinden hızlıca ulaşabilirsiniz.",
    href: null,
    actionLabel: "WhatsApp'tan Yaz",
    actionHref: "https://wa.me/908503469789",
  },
  {
    icon: Mail,
    title: "E-posta",
  ...
  },
  {
    icon: Instagram,
    title: "Instagram",
    desc: "Ruth Istanbul sosyal medya yönlendirmesi.",
    href: "https://www.instagram.com/theruthistanbul/",
    actionLabel: null,
    actionHref: null,
  },
];
  ...
  return (
    <div className="min-h-screen bg-ivory px-4 pb-24 pt-32 md:px-8">
      <div className="mx-auto max-w-5xl">
        <PageIntro
          eyebrow="İletişim"
          title="Her detay için buradayız."
          description="Sorularınız, sipariş süreçleriniz veya özel talepleriniz için Ruth Istanbul ekibine buradan ulaşabilirsiniz."
          align="left"
        />
        ...
        <AnimatedBlock delay={0.26}>
          <section className="mt-12 rounded-[2rem] border border-gold/15 bg-cream p-6 md:p-10">
            ...
            <div className="grid gap-5 text-sm leading-7 text-muted-ruth md:grid-cols-2">
              ...
              <div className="space-y-2">
                <p><strong className="text-ink">E-posta:</strong> <a className="hover:text-ink" href="mailto:ruthistanbull@gmail.com">ruthistanbull@gmail.com</a></p>
                <p><strong className="text-ink">Telefon:</strong> <a className="hover:text-ink" href="tel:+908503469789">0850 346 97 89</a></p>
