    ...
    <div style="padding:24px 12px">
      <div style="max-width:640px;margin:0 auto;background:#fffaf2;border:1px solid #e8dccb;border-radius:22px;overflow:hidden">
        <div style="padding:28px 28px 18px;text-align:center;border-bottom:1px solid #eadfce">
          <div style="font-family:Georgia,serif;font-size:26px;letter-spacing:.13em">ROSTA COFFEE CO.</div>
          <div style="margin-top:6px;font-size:9px;letter-spacing:.22em;color:#9a7b52">SPECIALTY COFFEE</div>
        </div>
        <div style="padding:30px 28px">
          ...
          <p style="margin:24px 0 0;text-align:center;color:#9a8d80;font-size:11px;line-height:1.6">Sevgiler,<br>ROSTA Coffee Co.</p>
        </div>
      </div>
    </div>
  </body></html>`;
