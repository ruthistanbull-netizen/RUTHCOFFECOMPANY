...
function iconSvg(size: number) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 512 512">
    <rect width="512" height="512" rx="${Math.round((radius / size) * 512)}" fill="#F4F0E8"/>
    <g transform="rotate(-18 256 256)">
      ...
      <path fill="none" stroke="#F4F0E8" stroke-width="34" stroke-linecap="round" d="M332 80c-49 44-71 91-63 145 7 56 4 113-67 201"/>
    </g>
  </svg>`;
}
