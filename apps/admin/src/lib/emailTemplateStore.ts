...
const fieldMarker = /^<!--RUTH_TEMPLATE_FIELDS:([A-Za-z0-9_-]+)-->/;
const defaultSite = "https://www.ruthistanbul.com";
...
function normalizeFields(value: unknown, fallback?: Partial<EmailTemplateFields>): EmailTemplateFields {
  ...
  return {
    ...
    buttonLabel: clean(source.buttonLabel, 120) || fallback?.buttonLabel || "Ruth Istanbul'u Keşfet",
