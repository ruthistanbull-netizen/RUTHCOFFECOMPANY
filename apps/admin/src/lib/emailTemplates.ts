...
export const readyEmailTemplates: EmailTemplateDefinition[] = [
  { key: "soft_discount", title: "Sade İndirim Duyurusu", category: "İndirim", description: "Yakın hissettiren, sade kampanya maili.", fields: { subject: "ROSTA Coffee Co.’dan küçük bir sürpriz", preheader: "Seçili parçalarda kısa süreli fırsat.", headline: "Seçili parçalarda küçük bir ROSTA fırsatı", intro: "Merhaba {{customer_name}}, günlük stiline kolayca eşlik edecek seçili ROSTA ürünlerinda kısa süreli bir fırsat hazırladık.", offer: "Sepetinde seçili ürünlerde avantajlı fiyatları görebilirsin.", buttonLabel: "Alışverişe Başla", buttonUrl: site, note: "Stoklarla sınırlıdır.", heroImageUrl: "" } },
  { key: "new_collection", title: "Yeni Koleksiyon", category: "Koleksiyon", description: "Yeni koleksiyon ve ürün duyurusu.", fields: { subject: "Yeni parçalar ROSTA Coffee Co.’da", preheader: "Yeni eklenen takıları ilk keşfedenlerden ol.", headline: "Yeni parçalar yayında", intro: "Merhaba {{customer_name}}, ROSTA Coffee Co.’da yeni eklenen parçalar yayına alındı.", offer: "Kolye, yüzük, bileklik ve setlerde yeni kombin seçenekleri seni bekliyor.", buttonLabel: "Yeni Ürünleri Keşfet", buttonUrl: site, note: "Her parça sınırlı stokla hazırlanır.", heroImageUrl: "" } },
  { key: "last_chance", title: "Son Şans", category: "Fırsat", description: "Az kalan stoklar için güçlü hatırlatma.", fields: { subject: "Beğendiğin parçalar tükenmeden", preheader: "Bazı ROSTA ürünlerinda stoklar azalıyor.", headline: "Tükenmeden önce son kez bak", intro: "Merhaba {{customer_name}}, bazı ROSTA ürünlerinda stoklar azalıyor.", offer: "Beğendiğin bir model varsa kaçırmadan tamamlayabilirsin.", buttonLabel: "Son Şans Ürünleri", buttonUrl: site, note: "Ürünler tekrar stoğa girmeyebilir.", heroImageUrl: "" } },
  { key: "abandoned_cart", title: "Sepet Hatırlatma", category: "Otomasyon", description: "Sepette kalan ürünleri hatırlatır.", fields: { subject: "Sepetindeki parçalar seni bekliyor", preheader: "Ödemeye geldiğin sepet hâlâ duruyor.", headline: "Sepetin seni bekliyor", intro: "Merhaba {{customer_name}}, ödemeye kadar geldiğin ROSTA ürünleri hâlâ seni bekliyor.", offer: "Kaldığın yerden devam edebilirsin.", buttonLabel: "Ödemeye Devam Et", buttonUrl: "{{checkout_url}}", note: "Stoklar sınırlıdır.", heroImageUrl: "" } },
  ...
  { key: "order_thanks", title: "Satın Alanlara Teşekkür", category: "Müşteri", description: "Satın alan müşterilere teşekkür maili.", fields: { subject: "ROSTA Coffee Co.’dan teşekkür", preheader: "Bizi tercih ettiğin için teşekkür ederiz.", headline: "Bizi tercih ettiğin için teşekkür ederiz", intro: "Merhaba {{customer_name}}, ROSTA Coffee Co.’dan alışveriş yaptığın için teşekkür ederiz.", offer: "Yeni kombin tamamlayıcılarını keşfedebilirsin.", buttonLabel: "ROSTA’yı Keşfet", buttonUrl: site, note: "Destek için her zaman bize yazabilirsin.", heroImageUrl: "" } },
  { key: "account_migrated", title: "Hesabın Taşındı", category: "Hizmet", description: "İkas üyelik geçiş bilgilendirmesi.", fields: { subject: "ROSTA Coffee Co. hesabın yeni sitemize taşındı", preheader: "Yeni şifreni oluştur.", headline: "Hesabın yeni ROSTA Coffee Co.’a taşındı", intro: "Merhaba {{customer_name}}, önceki üyelik kaydını yeni sitemizde hesabınla eşleştirdik.", offer: "Kişisel bağlantından yeni şifreni belirleyebilirsin.", buttonLabel: "Yeni Şifremi Oluştur", buttonUrl: "{{activation_url}}", note: "Bağlantı kişiye özeldir.", heroImageUrl: "" } },
  { key: "site_moved", title: "Yeni Siteye Taşındık", category: "Hizmet", description: "Yeni site duyurusu.", fields: { subject: "ROSTA Coffee Co. yeni adresinde", preheader: "Yeni sitemiz yayında.", headline: "Yeni sitemize taşındık", intro: "Merhaba {{customer_name}}, ROSTA Coffee Co.’un yeni sitesi artık yayında.", offer: "Yeni alışveriş deneyimini keşfedebilirsin.", buttonLabel: "Yeni Siteyi Aç", buttonUrl: site, note: "Bundan sonra www.ruthistanbul.com adresini kullanabilirsin.", heroImageUrl: "" } },
];
