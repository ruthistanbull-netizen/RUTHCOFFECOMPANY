...
export function ManualReturnLauncher() {
  ...
  return (
    <>
      <style jsx global>{`
        .cr-manual-return-launcher{position:fixed;top:92px;right:28px;z-index:45}.cr-manual-return-modal{position:fixed;inset:0;z-index:120;display:grid;place-items:center;padding:22px;overflow:hidden}.cr-manual-return-backdrop{position:absolute;inset:0;border:0;background:color-mix(in srgb,var(--rosta-carbon,#111111) 72%,transparent);backdrop-filter:blur(7px)}.cr-manual-return-dialog{position:relative;width:min(760px,100%);max-width:100%;min-width:0;max-height:calc(100dvh - 44px);overflow-y:auto;overflow-x:hidden;border:1px solid color-mix(in srgb,var(--rosta-kraft,#C8A77D) 36%,transparent);border-radius:26px;background:var(--rosta-carbon-soft,#242424);box-shadow:0 30px 90px rgba(0,0,0,.25)}.cr-manual-return-dialog>header{position:sticky;top:0;z-index:3;display:flex;align-items:flex-start;justify-content:space-between;gap:18px;min-width:0;padding:22px 24px;border-bottom:1px solid color-mix(in srgb,var(--rosta-kraft,#C8A77D) 24%,transparent);background:color-mix(in srgb,var(--rosta-carbon-soft,#242424) 96%,transparent);backdrop-filter:blur(18px)}.cr-manual-return-dialog>header>div{min-width:0}.cr-manual-return-body{display:grid;gap:18px;min-width:0;padding:22px 24px 28px}.cr-manual-order-results{display:grid;gap:8px;width:100%;min-width:0;max-height:320px;overflow-y:auto;overflow-x:hidden}.cr-manual-order-results button{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;width:100%;min-width:0;gap:16px;padding:14px;border:1px solid color-mix(in srgb,var(--rosta-kraft,#C8A77D) 24%,transparent);border-radius:16px;background:var(--rosta-carbon,#111111);text-align:left}.cr-manual-order-results button span{display:grid;min-width:0;gap:3px}.cr-manual-order-results button span strong{max-width:100%;overflow-wrap:anywhere;word-break:break-word}.cr-manual-order-results button>strong{white-space:nowrap}.cr-manual-order-results small{min-width:0;color:color-mix(in srgb,var(--rosta-cream,#FBF3E6) 70%,transparent);overflow-wrap:anywhere}.cr-manual-selected-order{min-width:0;padding:15px 17px;border:1px solid color-mix(in srgb,var(--rosta-kraft,#C8A77D) 42%,transparent);border-radius:18px;background:var(--rosta-carbon,#111111)}.cr-manual-selected-order>div{display:flex;align-items:center;justify-content:space-between;min-width:0;gap:12px}.cr-manual-selected-order span{min-width:0;overflow-wrap:anywhere}.cr-manual-item-list,.cr-manual-exchange-list{display:grid;min-width:0;gap:8px}.cr-manual-item-list button,.cr-manual-exchange-list article{display:flex;align-items:center;min-width:0;gap:12px;padding:12px;border:1px solid color-mix(in srgb,var(--rosta-kraft,#C8A77D) 24%,transparent);border-radius:14px;background:var(--rosta-carbon,#111111);text-align:left}.cr-manual-item-list button.is-selected{border-color:var(--rosta-brick-b,#C94A40);box-shadow:inset 0 0 0 1px var(--rosta-brick-b,#C94A40)}.cr-manual-item-list img,.cr-manual-exchange-list img{width:44px;height:56px;border-radius:8px;object-fit:cover}.cr-manual-item-list div,.cr-manual-exchange-list div{min-width:0;flex:1;display:grid;gap:3px}.cr-manual-product-results{display:grid;gap:8px;max-height:260px;overflow:auto}.cr-manual-product-results article{display:grid;min-width:0;gap:8px;padding:12px;border:1px solid color-mix(in srgb,var(--rosta-kraft,#C8A77D) 24%,transparent);border-radius:14px;background:var(--rosta-carbon,#111111)}.cr-manual-product-results article>div{display:flex;align-items:center;min-width:0;gap:10px}.cr-manual-product-results img{width:42px;height:52px;border-radius:8px;object-fit:cover}.cr-manual-product-actions{display:flex;flex-wrap:wrap;gap:7px}.cr-manual-form-actions{display:flex;justify-content:flex-end;gap:10px;padding-top:6px}@media(max-width:767px){.cr-manual-return-launcher{top:auto;right:14px;bottom:82px}.cr-manual-return-launcher .cr-button{min-height:46px;font-size:11px}.cr-manual-return-modal{padding:8px}.cr-manual-return-dialog{width:calc(100vw - 16px);max-height:calc(100dvh - 16px);border-radius:20px}.cr-manual-return-dialog>header,.cr-manual-return-body{padding:18px 16px}.cr-manual-order-results button{grid-template-columns:minmax(0,1fr);gap:8px}.cr-manual-order-results button>strong{justify-self:start}.cr-manual-selected-order>div{align-items:flex-start;flex-direction:column}.cr-manual-form-actions{position:sticky;bottom:0;padding:12px 0;background:var(--rosta-carbon-soft,#242424)}}
      `}</style>
