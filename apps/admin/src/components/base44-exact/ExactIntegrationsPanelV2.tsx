...
const definitions: Integration[] = [
  ...
  { key: "github", label: "GitHub", description: "Kod, commit, PR ve geliştirme bağlantısı", scopes: ["panel", "ruthie"], icon: Github, mode: "server", help: ["Yalnız ROSTA Coffee Co. reposuna erişim ver.", "Repo bağlantısını ve erişimi güvenli sunucu ayarlarında sakla.", "Ruthie geliştirme işlemiyle bağlantıyı test et."] },
