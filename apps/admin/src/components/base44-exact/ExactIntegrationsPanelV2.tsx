...
const definitions: Integration[] = [
  ...
  { key: "google-tag-manager", label: "Google Tag Manager", description: "Piksel, dönüşüm ve event etiketleri", scopes: ["panel", "marketing"], icon: Tag, mode: "server", help: ["ROSTA için web container oluştur.", "Admin Zeabur servisine GTM_CONTAINER_ID ve storefront servisine aynı değeri NEXT_PUBLIC_GTM_ID olarak ekle.", "GTM Preview ile page_view, view_item, add_to_cart, begin_checkout ve add_payment_info eventlerini test et."] },
