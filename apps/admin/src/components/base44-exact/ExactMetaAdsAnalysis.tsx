...
export function ExactMetaAdsAnalysis() {
  ...
  const startAnalysis = async () => {
    ...
    } catch (error) { toast.error(error instanceof Error ? error.message : "Ruthie reklam analizini tamamlayamadı."); }
