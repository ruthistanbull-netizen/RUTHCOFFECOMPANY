...
export function ExactAuthReset({ mode }: { mode: "reset" }) {
  ...
  if (!bootstrapped) {
    return (
      <main
        className="relative min-h-[100dvh] overflow-hidden bg-[#111111] text-[#FBF3E6]"
      ...
      >
        ...
        <section className="relative z-10 flex min-h-[calc(100dvh-72px)] items-start justify-center px-5 pb-[max(2rem,env(safe-area-inset-bottom))] pt-8 sm:min-h-[calc(100dvh-86px)] sm:items-center sm:pb-16 sm:pt-0">
          <div className="w-full max-w-[450px] rounded-[8px] border border-white/[0.08] bg-[#242424]/92 px-6 py-10 text-center shadow-[0_30px_80px_rgba(0,0,0,.38)] backdrop-blur-[6px] sm:px-14 sm:py-12">
            <img
              src="/rr-hub-cream.svg"
              alt="RR HUB"
              draggable={false}
            ...
            />
            <div className="mx-auto h-7 w-7 animate-spin rounded-full border-2 border-[#FBF3E6]/20 border-t-[#FBF3E6]" />
            <p className="mt-5 text-[13px] font-medium text-[#FBF3E6]/72">
