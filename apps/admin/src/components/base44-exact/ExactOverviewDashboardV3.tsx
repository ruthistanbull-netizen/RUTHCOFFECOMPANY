    ...
    <div className="space-y-4 animate-fade-in" data-exact-base44-page="overview-v3" data-dashboard-range={range.range}>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
          ...
          <div role="button" tabIndex={0} onClick={openRuthie} onKeyDown={onInsightKeyDown} className="cursor-pointer rounded-[var(--radius-card)] lg:col-span-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent" aria-label="ROSTA Insight sohbetini aç">
