...
export const exactNavStructure: ExactNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Ürün Seçenekleri", path: "/product-options", icon: ListPlus, exact: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "ROSTA Insight Reklam Analizi", path: "/meta-ads/analysis", icon: RuthieBrandIcon, badge: "AI" },
    ],
  },
  {
    label: "MAĞAZA",
