...
const emptyForm: ProductForm = { productType: "single", name: "", slug: "", price: "", compare_at_price: "", material: "Arabica", finish_color: "", short_description: "", description: "", size_usage: "", care_advice: "Serin, kuru ve güneş almayan bir yerde; paketi hava almayacak şekilde kapalı saklayın.", status: "active", stock_status: "in_stock", collection_ids: [], category_ids: [] };
