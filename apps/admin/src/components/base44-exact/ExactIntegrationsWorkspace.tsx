...
const integrations: Definition[] = [
  ...
  { key: "openai", label: "OpenAI · ROSTA Insight", description: "ROSTA Insight sohbeti, analiz ve onaylı panel işlemleri", scopes: ["ruthie"], icon: Sparkles, mode: "server", href: "/ruthie", setup: ["OpenAI projesi için sunucu API erişimi oluştur.", "Erişimi yalnız Render admin servisinde sakla.", "ROSTA Insight ekranından sohbet ve onay akışını test et."] },
  ...
  { key: "github", label: "GitHub", description: "Kod, commit, PR ve ROSTA Insight geliştirme araçları", scopes: ["panel", "ruthie"], icon: Github, mode: "server", setup: ["Yalnız Ruth Commerce reposuna yetkili erişim oluştur.", "Repo ve erişim bilgisini admin servisine ekle.", "ROSTA Insight geliştirme işlemlerinde bağlantıyı test et."] },
