...
const integrations: Definition[] = [
  ...
  { key: "github", label: "GitHub", description: "Kod, commit, PR ve Ruthie geliştirme araçları", scopes: ["panel", "ruthie"], icon: Github, mode: "server", setup: ["Yalnız Ruth Commerce reposuna yetkili erişim oluştur.", "Repo ve erişim bilgisini admin servisine ekle.", "Ruthie geliştirme işlemlerinde bağlantıyı test et."] },
