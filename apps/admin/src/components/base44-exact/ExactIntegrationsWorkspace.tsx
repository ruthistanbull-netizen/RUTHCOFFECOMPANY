...
const integrations: Definition[] = [
  ...
  { key: "tiktok", label: "TikTok Ads", description: "TikTok reklam raporları ve performans analizi", scopes: ["ruthie", "marketing"], icon: Megaphone, mode: "server", setup: ["TikTok for Business geliştirici uygulaması oluştur.", "Reklam hesabı erişimini uygulamaya bağla.", "TIKTOK_ACCESS_TOKEN ve TIKTOK_ADVERTISER_ID değerlerini admin Zeabur servisine ekleyip yeniden yayınla."] },
